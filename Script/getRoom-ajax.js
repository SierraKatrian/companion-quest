      ...
      $.get('./Models/searchroom.php',{gameName:"", gametheme:"", gamelanguage:""}, function (data) {
        ...
        $.each(data, function(index,object){
          $("#search-output").append(
            "<tr><td><img class='access-colours' src='./Images/status-colours/" + ((object[0].game_status == 1) ? 'access-granted.svg' : 'access-locked.svg')+"'/></td><td>"+object[0].game_name+"</td><td>"+object[0].user_name+"</td><td>"+object[0].lang+"</td><td>"+object[0].max_players+"</td><td>"+object[0].name+"</td><td><button class=\"btn btn-primary request\" id=\""+object[0].game_name+"\">Send Request</button></td></tr>"
          );
        })
      });
